...
class HIMLocoONNXWrapper(nn.Module):
    ...
    def forward(self, obs_history):
        """
        输入: obs_history (batch, 270) — 原始观测历史
        输出: actions (batch, 12)
        """
...
def export():
    ...
    MODEL_PATH = "/home/zhy/桌面/IsaacGym_Preview_4_Package/HIMLoco-main/himloco_gym/logs/dog_rough/Apr25_15-34-37_/model_3400.pt"
    ...
    # ========== 5. 创建 dummy 输入并验证 ==========
    num_obs = policy.num_actor_obs  # 通常为 270 = 45 * 6
    ...
    # ========== 6. 导出 ONNX ==========
    output_path = '/home/zhy/桌面/IsaacGym_Preview_4_Package/HIMLoco-main/himloco_gym/logs/dog_rough/Apr25_15-34-37_/model_3400.onnx'
